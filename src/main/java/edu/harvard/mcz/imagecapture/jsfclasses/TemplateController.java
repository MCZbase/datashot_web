...
public class TemplateController  implements Serializable {
	...
	private static final long serialVersionUID = -7770975753796746319L;
	
	private Template current;
    private DataModel items = null;
    @EJB
    private edu.harvard.mcz.imagecapture.ejb.TemplateFacadeLocal ejbFacade;
    ...
    private TemplateFacadeLocal getFacade() {
        return ejbFacade;
    }
    ...
    public static class TemplateControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Template) {
                ...
                return getStringKey(o.getTemplateId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+TemplateController.class.getName());
            }
        }
